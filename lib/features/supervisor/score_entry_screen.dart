                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [
                        ...
                        AppTheme.supervisorColor.withOpacity(0.7)
                      ],
                    ),
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        '(${(_logbook + _technicalReport + _industrialReport).toStringAsFixed(0)} / 60 raw marks)',
                        style: GoogleFonts.outfit(
                      ...
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: (_preview / 60).clamp(0.0, 1.0),
                          minHeight: 8,
